...
const ModalAlert = () => {
    ...
    return (
        ...
        }} className={`${isModalAlert ? "flex" : "hidden"} overlay fixed z-20 top-0 bg-black bg-opacity-50 backdrop-blur-[2px] left-0 right-0 bottom-0  justify-center pt-[15vh] overflow-y-auto`}>
            <motion.div
